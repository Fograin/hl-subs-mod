...
void UTIL_EmitAmbientSound( edict_t *entity, const Vector &vecOrigin, const char *samp, float vol, float attenuation, int fFlags, int pitch )
{
	...
	UTIL_ShowMessagePVS( samp, vecOrigin ); // Fograin92: Trigger ShowMessage on every sound
}
...
// Fograin92: Send subtitle message to all players (Code by: Buzzer, edited by: Fograin92)
void UTIL_ShowMessagePVS( const char *pString, const Vector &org )
{
	//////////////////////////////////
	// ambient_generic voices FIX
	//////////////////////////////////

	// Train voice
	if( !strcmp( pString, "tride/c0a0_tr_gmorn.wav" ) ) strcpy(const_cast<char*>(pString), "TR_01");
	else if( !strcmp( pString, "tride/c0a0_tr_time.wav" ) ) strcpy(const_cast<char*>(pString), "TR_02");
	else if( !strcmp( pString, "tride/c0a0_tr_dest.wav" ) ) strcpy(const_cast<char*>(pString), "TR_03");
	else if( !strcmp( pString, "tride/c0a0_tr_noeat.wav" ) ) strcpy(const_cast<char*>(pString), "TR_04");
	else if( !strcmp( pString, "tride/c0a0_tr_emerg.wav" ) ) strcpy(const_cast<char*>(pString), "TR_05");
	else if( !strcmp( pString, "tride/c0a0_tr_tourn.wav" ) ) strcpy(const_cast<char*>(pString), "TR_06");
	else if( !strcmp( pString, "tride/c0a0_tr_jobs.wav" ) ) strcpy(const_cast<char*>(pString), "TR_07");
	else if( !strcmp( pString, "tride/c0a0_tr_haz.wav" ) ) strcpy(const_cast<char*>(pString), "TR_08");
	else if( !strcmp( pString, "tride/c0a0_tr_arrive.wav" ) ) strcpy(const_cast<char*>(pString), "TR_09");
	else if( !strcmp( pString, "tride/c0a0_tr_exit.wav" ) ) strcpy(const_cast<char*>(pString), "TR_10");

	// Hazard Course - Gina voice
	else if( !strcmp( pString, "holo/tr_holo_nicejob.wav" ) ) strcpy(const_cast<char*>(pString), "!HOLO_NICEJOB");
	else if( !strcmp( pString, "holo/tr_holo_keeptrying.wav" ) ) strcpy(const_cast<char*>(pString), "!HOLO_KEEPTRYING");
	else if( !strcmp( pString, "holo/tr_holo_fallshort.wav" ) ) strcpy(const_cast<char*>(pString), "!HOLO_FALLSHORT");
	else if( !strcmp( pString, "holo/tr_holo_greatwork.wav" ) ) strcpy(const_cast<char*>(pString), "!HOLO_GREATWORK");
	else if( !strcmp( pString, "holo/tr_holo_nicejob.wav" ) ) strcpy(const_cast<char*>(pString), "!HOLO_NICEJOB");
	else if( !strcmp( pString, "holo/tr_holo_jumpdown.wav" ) ) strcpy(const_cast<char*>(pString), "!HOLO_JUMPDOWN");
	else if( !strcmp( pString, "holo/tr_holo_fantastic.wav" ) ) strcpy(const_cast<char*>(pString), "!HOLO_FANTASTIC");
	else if( !strcmp( pString, "holo/tr_holo_flashlight.wav" ) ) strcpy(const_cast<char*>(pString), "!HOLO_FLASHLIGHT");
	else if( !strcmp( pString, "holo/tr_holo_lightoff.wav" ) ) strcpy(const_cast<char*>(pString), "!HOLO_LIGHTOFF");
	else if( !strcmp( pString, "holo/tr_holo_breath.wav" ) ) strcpy(const_cast<char*>(pString), "!HOLO_BREATH");
	else if( !strcmp( pString, "holo/tr_holo_radiation.wav" ) ) strcpy(const_cast<char*>(pString), "!HOLO_RADIATION");
	else if( !strcmp( pString, "holo/tr_holo_done.wav" ) ) strcpy(const_cast<char*>(pString), "!HOLO_DONE");

	// Random NPC fixes
	else if( !strcmp( pString, "*scientist/c1a0_sci_stayback.wav" ) ) strcpy(const_cast<char*>(pString), "SC_STAYBACK");
	else if( !strcmp( pString, "*scientist/c1a4_sci_rocket.wav" ) ) strcpy(const_cast<char*>(pString), "SC_ROCKET");
	else if( !strcmp( pString, "*scientist/c1a4_sci_tent.WAV" ) ) strcpy(const_cast<char*>(pString), "SC_TENT");
	else if( !strcmp( pString, "hgrunt/c2a3_ambush_vox.wav" ) ) strcpy(const_cast<char*>(pString), "HG_AMBUSHA");
	else if( !strcmp( pString, "hgrunt/c2a5_hg_abandon.wav" ) ) strcpy(const_cast<char*>(pString), "HG_ABANDON");
	else if( !strcmp( pString, "hgrunt/c2a5_hg_lebuz.wav" ) ) strcpy(const_cast<char*>(pString), "HG_LEBUZ");
	else if( !strcmp( pString, "barney/c2a4_ba_1tau.wav" ) ) strcpy(const_cast<char*>(pString), "!BA_TAU1A");
	else if( !strcmp( pString, "barney/c2a4_ba_3tau.wav" ) ) strcpy(const_cast<char*>(pString), "!BA_TAU3A");
	else if( !strcmp( pString, "barney/c2a4_ba_5tau.wav" ) ) strcpy(const_cast<char*>(pString), "!BA_TAU5A");
	else if( !strcmp( pString, "scientist/c2a4_sci_2tau.wav" ) ) strcpy(const_cast<char*>(pString), "!SC_TAU2A");
	else if( !strcmp( pString, "scientist/c2a4_sci_4tau.wav" ) ) strcpy(const_cast<char*>(pString), "!SC_TAU4A");
	else if( !strcmp( pString, "gman/gman_wise.wav" ) ) strcpy(const_cast<char*>(pString), "!GM_WISE");
	else if( !strcmp( pString, "gman/gman_noreg.wav" ) ) strcpy(const_cast<char*>(pString), "!GM_REGRET");

	// Nihilanth
	else if( !strcmp( pString, "nihilanth/nil_alone.wav" ) ) strcpy(const_cast<char*>(pString), "NIL_ALONE");
	else if( !strcmp( pString, "nihilanth/nil_comes.wav" ) ) strcpy(const_cast<char*>(pString), "NIL_COMES");
	else if( !strcmp( pString, "nihilanth/nil_deceive.wav" ) ) strcpy(const_cast<char*>(pString), "NIL_DECE");
	else if( !strcmp( pString, "nihilanth/nil_die.wav" ) ) strcpy(const_cast<char*>(pString), "NIL_DIE");
	else if( !strcmp( pString, "nihilanth/nil_done.wav" ) ) strcpy(const_cast<char*>(pString), "NIL_DONE");
	else if( !strcmp( pString, "nihilanth/nil_freeman.wav" ) ) strcpy(const_cast<char*>(pString), "NIL_FREEMAN");
	else if( !strcmp( pString, "nihilanth/nil_last.wav" ) ) strcpy(const_cast<char*>(pString), "NIL_LAST");
	else if( !strcmp( pString, "nihilanth/nil_man_notman.wav" ) ) strcpy(const_cast<char*>(pString), "NIL_NOMAN");
	else if( !strcmp( pString, "nihilanth/nil_now_die.wav" ) ) strcpy(const_cast<char*>(pString), "NIL_NOWDIE");
	else if( !strcmp( pString, "nihilanth/nil_slaves.wav" ) ) strcpy(const_cast<char*>(pString), "NIL_SLAVES");
	else if( !strcmp( pString, "nihilanth/nil_thelast.wav" ) ) strcpy(const_cast<char*>(pString), "NIL_ILAST");
	else if( !strcmp( pString, "nihilanth/nil_thetruth.wav" ) ) strcpy(const_cast<char*>(pString), "NIL_TRUTH");
	else if( !strcmp( pString, "nihilanth/nil_thieves.wav" ) ) strcpy(const_cast<char*>(pString), "NIL_THIEVES");
	else if( !strcmp( pString, "nihilanth/nil_win.wav" ) ) strcpy(const_cast<char*>(pString), "NIL_WIN");

	// All not SENTENCed voices has been fixed with proper name
	// After this point DON'T pass any other strings without "!" in them
	else if(*pString != '!') return;
	...
	// Scientists and security guards SPAM post-distaster sounds like crazy
	// This little HACK will disable subtitles for all senteces on intro maps
	// Ambient_generic, train voice still will be passed for subtitles
	else if( !strcmp( STRING(gpGlobals->mapname), "c0a0" ) ) return;
	else if( !strcmp( STRING(gpGlobals->mapname), "c0a0a" ) ) return;
	else if( !strcmp( STRING(gpGlobals->mapname), "c0a0b" ) ) return;
	else if( !strcmp( STRING(gpGlobals->mapname), "c0a0c" ) ) return;


	//ALERT( at_console, "Sound passed: %s \n", pString );
