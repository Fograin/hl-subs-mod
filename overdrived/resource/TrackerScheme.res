...
Scheme
{
	...
	Colors
	{
		...
		// background colors
		"ControlBG"			"7 7 135 255"		// background color of controls
		"ControlDarkBG"		"36 36 92 255"		// darker background color; used for background of scrollbars
		"WindowBG"			"23 64 81 255"		// background color of text edit panes (chat, text entries, etc.)
		...
		"ListBG"			"23 64 81 255"		// background of server browser, buddy list, etc.
