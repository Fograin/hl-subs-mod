...
//#ifndef SM_BSHIFT
#define		NUM_Civilian_HEADS		4 // four heads available for Civilian model
// OVERDRIVE makes Rosenberg use a different model
//#else
//#define		NUM_Civilian_HEADS		3 // three heads available for Civilian model in Blue Shift, the 4th is used for Rosenberg
//#endif
...
//=========================================================
#define		Civilian_AE_HEAL		( 1 )
#define		Civilian_AE_NEEDLEON	( 2 )
#define		Civilian_AE_NEEDLEOFF	( 3 )
...
Schedule_t	slFollowcivilian[] =
{
	{
		tlFollowcivilian,
		ARRAYSIZE(tlFollowcivilian),
		bits_COND_NEW_ENEMY |
...
Schedule_t	slFollowcivilianScared[] =
{
	{
		tlFollowcivilianScared,
		ARRAYSIZE(tlFollowcivilianScared),
		bits_COND_NEW_ENEMY |
		bits_COND_HEAR_SOUND |
		bits_COND_LIGHT_DAMAGE |
		bits_COND_HEAVY_DAMAGE,
...
Task_t	tlFacecivilianTargetScared[] =
{
...
Schedule_t	slFacecivilianTargetScared[] =
{
	{
		tlFacecivilianTargetScared,
		ARRAYSIZE(tlFacecivilianTargetScared),
		bits_COND_HEAR_SOUND |
		bits_COND_NEW_ENEMY,
		bits_SOUND_DANGER,
		"FaceTargetScared"
...
Task_t	tlStopcivilianFollowing[] =
{
	{ TASK_CANT_FOLLOW, (float)0 },
};

Schedule_t	slStopcivilianFollowing[] =
{
	{
		tlStopcivilianFollowing,
		ARRAYSIZE(tlStopcivilianFollowing),
		0,
		0,
		"StopFollowing"
	},
...
Schedule_t	slHealcivilian[] =
{
	{
		tlHealcivilian,
		ARRAYSIZE(tlHealcivilian),
...
Schedule_t	slFacecivilianTarget[] =
{
	{
		tlFacecivilianTarget,
		ARRAYSIZE(tlFacecivilianTarget),
...
Schedule_t	slScicivilianPanic[] =
{
	{
		tlScicivilianPanic,
		ARRAYSIZE(tlScicivilianPanic),
		0,
		0,
		"SciPanic"
	},
...
Schedule_t	slIdlecivilianSciStand[] =
{
	{
		tlIdlecivilianSciStand,
		ARRAYSIZE(tlIdlecivilianSciStand),
		bits_COND_NEW_ENEMY |
		bits_COND_LIGHT_DAMAGE |
		bits_COND_HEAVY_DAMAGE |
		bits_COND_HEAR_SOUND |
...
Task_t	tlScicivilianentistcivilianCover[] =
{
...
Schedule_t	slScicivilianentistcivilianCover[] =
{
	{
		tlScicivilianentistcivilianCover,
		ARRAYSIZE(tlScicivilianentistcivilianCover),
		bits_COND_NEW_ENEMY,
		0,
		"CivilianCover"
	},
...
Task_t	tlScicivilianentistcivilianHide[] =
{
	{ TASK_SET_FAIL_SCHEDULE, (float)SCHED_PANIC },		// If you fail, just panic!
	{ TASK_STOP_MOVING, (float)0 },
...
Schedule_t	slScicivilianentistcivilianHide[] =
{
	{
		tlScicivilianentistcivilianHide,
		ARRAYSIZE(tlScicivilianentistcivilianHide),
		bits_COND_NEW_ENEMY |
		bits_COND_HEAR_SOUND |
		bits_COND_SEE_ENEMY |
		bits_COND_SEE_HATE |
...
Task_t	tlScicivilianentistcivilianStartle[] =
{
	{ TASK_SET_FAIL_SCHEDULE, (float)SCHED_PANIC },		// If you fail, just panic!
...
Schedule_t	slScicivilianentistcivilianStartle[] =
{
	{
		tlScicivilianentistcivilianStartle,
		ARRAYSIZE(tlScicivilianentistcivilianStartle),
		bits_COND_NEW_ENEMY |
		bits_COND_SEE_ENEMY |
		bits_COND_SEE_HATE |
		bits_COND_SEE_FEAR |
...
Schedule_t	slFearcivilian[] =
{
	{
		tlFearcivilian,
		ARRAYSIZE(tlFearcivilian),
		bits_COND_NEW_ENEMY,
		0,
		"Fear"
	},
...
{
	slFollowcivilian,
		slFacecivilianTarget,
		slIdlecivilianSciStand,
		slFearcivilian,
		slScicivilianentistcivilianCover,
		slScicivilianentistcivilianHide,
		slScicivilianentistcivilianStartle,
		slHealcivilian,
		slStopcivilianFollowing,
		slScicivilianPanic,
		slFollowcivilianScared,
		slFacecivilianTargetScared,
};
...
void CCivilian::HandleAnimEvent(MonsterEvent_t *pEvent)
{
	switch (pEvent->event)
	{
	case Civilian_AE_HEAL:		// Heal my target (if within range)
		Heal();
		break;
	case Civilian_AE_NEEDLEON:
	{
		int oldBody = pev->body;
		pev->body = (oldBody % NUM_Civilian_HEADS) + NUM_Civilian_HEADS * 1;
	}
	break;
	case Civilian_AE_NEEDLEOFF:
	{
		int oldBody = pev->body;
		pev->body = (oldBody % NUM_Civilian_HEADS) + NUM_Civilian_HEADS * 0;
	}
	break;
...
void CCivilian::Precache(void)
{
	...
	PRECACHE_SOUND("Civilian/sci_pain1.wav");
	PRECACHE_SOUND("Civilian/sci_pain2.wav");
	PRECACHE_SOUND("Civilian/sci_pain3.wav");
	PRECACHE_SOUND("Civilian/sci_pain4.wav");
	PRECACHE_SOUND("Civilian/sci_pain5.wav");
...
void CCivilian::TalkInit()
{
	...
	m_szFriends[2] = "monster_civilian";
	m_szFriends[3] = "monster_sitting_civilian";
...
void CCivilian::PainSound(void)
{
	...
	{
	case 0: EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "Civilian/sci_pain1.wav", 1, ATTN_NORM, 0, GetVoicePitch()); break;
	case 1: EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "Civilian/sci_pain2.wav", 1, ATTN_NORM, 0, GetVoicePitch()); break;
	case 2: EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "Civilian/sci_pain3.wav", 1, ATTN_NORM, 0, GetVoicePitch()); break;
	case 3: EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "Civilian/sci_pain4.wav", 1, ATTN_NORM, 0, GetVoicePitch()); break;
	case 4: EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "Civilian/sci_pain5.wav", 1, ATTN_NORM, 0, GetVoicePitch()); break;
	}
}
...
Schedule_t* CCivilian::GetScheduleOfType(int Type)
{
	...
	case SCHED_TARGET_FACE:
		...
		if (psched == slIdleStand)
			return slFacecivilianTarget;	// override this for different target face behavior
		else
			return psched;

	case SCHED_TARGET_CHASE:
		return slFollowcivilian;

	case SCHED_CANT_FOLLOW:
		return slStopcivilianFollowing;

	case SCHED_PANIC:
		return slScicivilianPanic;

	case SCHED_TARGET_CHASE_SCARED:
		return slFollowcivilianScared;

	case SCHED_TARGET_FACE_SCARED:
		return slFacecivilianTargetScared;
	...
	case SCHED_HIDE:
		return slScicivilianentistcivilianHide;

	case SCHED_STARTLE:
		return slScicivilianentistcivilianStartle;

	case SCHED_FEAR:
		return slFearcivilian;
	}
...
Schedule_t *CCivilian::GetSchedule(void)
{
	...
	case MONSTERSTATE_COMBAT:
		if (HasConditions(bits_COND_NEW_ENEMY))
			return slFearcivilian;					// Point and scream!
		if (HasConditions(bits_COND_SEE_ENEMY))
			return slScicivilianentistcivilianCover;		// Take Cover

		if (HasConditions(bits_COND_HEAR_SOUND))
			return slTakeCoverFromBestSound;	// Cower and panic from the scary sound!

		return slScicivilianentistcivilianCover;			// Run & Cower
		break;
	}
