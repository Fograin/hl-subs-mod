...
void COtis::Killed(entvars_t *pevAttacker, int iGib)
{
	...
	{// drop the gun!
		...
		CBaseEntity *pGun = DropItem("weapon_9mmhandgun", vecGunPos, vecGunAngles); //Have him still drop the 9MM Glock
		//CBaseEntity *pGun = DropItem("weapon_eagle", vecGunPos, vecGunAngles);    //Until the deagle is in
	}
