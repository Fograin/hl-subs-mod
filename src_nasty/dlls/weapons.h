...
public:
	...
	BOOL DefaultDeploy(char *szViewModel, char *szViewModelShepard, char *szViewModelBarney, char *szWeaponModel, int iAnim, char *szAnimExt, int skiplocal = 0, int body = 0);
