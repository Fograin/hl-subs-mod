...
typedef struct cl_enginefuncs_s
{
	...
	pfnEngSrc_pfnPlaySoundByName_t			pfnPlaySoundByName_Hooked;	// Vit_amiN: hooked
	pfnEngSrc_pfnPlaySoundByIndex_t			pfnPlaySoundByIndex_Hooked;	// Vit_amiN: hooked
	...
	pfnEngSrc_pfnPlaySoundByNameAtLocation_t	pfnPlaySoundByNameAtLocation_Hooked;	// Vit_amiN: hooked
	...
	pfnEngSrc_pfnPlaySoundVoiceByName_t	pfnPlaySoundVoiceByName_Hooked;	// Vit_amiN: hooked
	...
	pfnEngSrc_pfnPlaySoundByNameAtPitch_t	pfnPlaySoundByNameAtPitch_Hooked;	// Vit_amiN: hooked
